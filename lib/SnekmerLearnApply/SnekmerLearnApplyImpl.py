...
This will have to be changed soon.
    ...
    def run_SnekmerLearnApply(self, ctx, params):
        ...
        #     'description': 'Files generated by Snekmer Apply'}])
    
        logging.info(os.path.join(cwd, "output", "apply","kmer-summary-output1.csv"))
        ...
        report_params = {
            ...
            'file_links': [
                {
                    'path': os.path.join(cwd, "output", "apply","kmer-summary-output1.csv"),
